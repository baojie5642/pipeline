...
public class D_PartOfTask {
	...
	public static D_PartOfTask build(final String partLineTaskName) {
		return new D_PartOfTask(partLineTaskName);
	}

	private D_PartOfTask(final String partLineTaskName) {
