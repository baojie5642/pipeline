...
public class C_PartOfTask {
	...
	public static C_PartOfTask build(final String partLineTaskName) {
		return new C_PartOfTask(partLineTaskName);
	}

	private C_PartOfTask(final String partLineTaskName) {
