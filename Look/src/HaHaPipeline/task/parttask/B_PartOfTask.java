...
public class B_PartOfTask {
	...
	public static B_PartOfTask build(final String partLineTaskName) {
		return new B_PartOfTask(partLineTaskName);
	}

	private B_PartOfTask(final String partLineTaskName) {
